<x-ui.card>
    <x-slot:header>
        <div class="flex justify-between">
            <div>
                ...
                <p class="mt-1 text-theme-sm" style="color: var(--text-secondary);">
            ...
            <div x-data="{openDropDown: false}" class="relative h-fit">
                <button @click="openDropDown = !openDropDown" style="color: var(--text-secondary);">
                ...
                <div x-show="openDropDown" @click.outside="openDropDown = false"
                    class="absolute right-0 z-40 w-40 p-2 space-y-1 shadow-theme-lg top-full rounded-2xl"
                    style="background-color: var(--bg-surface); border: 1px solid var(--border-color); display: none;">
                    <button wire:click="$set('chartType', 'users'); openDropDown = false"
                        class="flex w-full px-3 py-2 font-medium text-left rounded-lg text-theme-xs"
    ...
    <p class="mx-auto mt-1.5 w-full max-w-[380px] text-center text-sm sm:text-base" style="color: var(--text-secondary);">
        @if($chartType === 'users')
    ...
    <x-slot:footer>
        <div class="flex items-center justify-center gap-5 sm:gap-8">
            <div>
                <p class="mb-1 text-center text-theme-xs sm:text-sm" style="color: var(--text-secondary);">
                    Alvo
                </p>
            ...
            <div class="h-7 w-px" style="background-color: var(--border-color);"></div>
