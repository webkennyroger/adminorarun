...
<div class="space-y-1.5">
    ...
    <textarea
        rows="{{ $rows }}"
        {{ $attributes->merge([
            'class' => 'w-full rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/40 focus:border-emerald-500 transition-all duration-200 px-4 py-2.5 text-sm resize-y ' .
